	...
	<?php if($plxShow->plxMotor->plxRecord_coms): ?>
		...
		<div id="<?php $plxShow->comId(); ?>" class="comment">
				...
				<p class="info_comment">
					...
					<span class="right"><a class="num-com" href="<?php $plxShow->ComUrl(); ?>" title="#<?php echo $plxShow->plxMotor->plxRecord_coms->i+1 ?>">#<?php echo $plxShow->plxMotor->plxRecord_coms->i+1 ?></a></span>
				</p>
